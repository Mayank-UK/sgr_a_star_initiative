...
//           const checkbox = document.createElement("input");
//           checkbox.type = "checkbox";
//           // Only check consolidated section by default
//           checkbox.checked = isConsolidated;
...
//       // Only show sections that are checked (consolidated by default)
//       const sectionsToShow = document.querySelectorAll('div[id^="section-"]');
//       sectionsToShow.forEach((section, index) => {
...
//           }, index * 50);
//         } else {
//           // Hide non-consolidated sections initially
//           section.style.display = "none";
//         }
//       });

//       // Faster loading completion since we're only processing consolidated
//       const consolidatedSections = Array.from(sectionsToShow).filter(section => 
//         section.id.toLowerCase().includes('consolidated')
//       );
...
//         loading.style.transition = "opacity 0.3s ease-out";
//         setTimeout(() => loading.remove(), 300);
//       }, consolidatedSections.length * 50 + 100);
